...
inventario = [
    ...
    {"id": "005", "modelo": "Rice Cream", "marca": "I'm from", "precio": 345.00, "cantidad": "50g", "stock": 20, "descripcion": "Crema humectante de arroz"},
...
# día 2
btn1 = tk.Butto(frame_botones, text="INVENTARIO", command=mostrar_inventario, **btn_style)
...
texto.tag_config("alerta", background= "#ffe5e5", foreground= "#006fee", font= ("Open Sans", 11, "bold"))
texto.tag_config("agotado", background= "#fddede", foreground= "#006fee", font= ("Open Sans", 11, "bold"))

# día 2
footer = tk.Label(ventana, text= " © 2025 Bunny Sneaker Store | DÍA 2 (MARTES) - Boton Inventario y Agregar Productos",
